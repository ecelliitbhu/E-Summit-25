  ...
  return (
    <article className="m-auto block w-calc[60vw + 248px] max-w-[1068px] min-w-[888px] text-xl font-sans font-normal max-[1100px]:px-12 max-[1100px]:pb-6 max-[1100px]:pt-24 max-lg:w-full max-lg:max-w-full max-lg:min-w-full max-md:pb-0 max-md:pt-12 max-md:px-6">
      {cards.map((card, index) => (
        <section
          className={`dark bg-card flex flex-row self-start relative w-4/5 max-w-[920px] min-w-[640px] my-20 mx-0 p-12 pl-[308px] rounded-3xl odd:m-0 odd:ml-60 odd:rounded-3xl odd:my-12 odd:pr-80 odd:pl-16 max-lg:w-full max-lg:max-w-full max-lg:min-w-full max-lg:odd:m-0 max-md:my-16 max-md:mx-0 max-md:pt-18 max-md:px-9 max-md:pb-9 max-md:flex-col max-lg:rounded-3xl 

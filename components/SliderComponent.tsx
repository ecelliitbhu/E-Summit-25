...
const ResponsiveComponent = () => {
  ...
  const slidesData = [
    ...
    { name: "Participant 4", description: "College Fresher", post: "As a first-time attendee, I appreciated how approachable the speakers were. The panel discussions on funding and scaling startups were particularly useful.", img: "/images/profile4.jpg" },
    { name: "Participant 5", description: "Aspiring Product Manager", post: "The diversity of topics covered in the summit was impressive. From technology trends to leadership skills, every session added value to my entrepreneurial knowledge.", img: "/images/profile5.jpg" }
  ];
  const brandLogos=[

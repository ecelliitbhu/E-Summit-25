      ...
      <div className={styles.card}>
        <div className={styles.cardContent}>
          ...
          <p className={"m-0 text-secondary"}>
            ...
            the future.&ldquo; E-Summit is where dreams are nurtured,ideas are
            cultivated, and future entrepreneurs are born. Join us in this
            exhilarating journey of entrepreneurship, and together Let&apos;s
            write the future!
          </p>
        </div>
      </div>
